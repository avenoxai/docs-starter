...
- **Protects against bots** during the first 2 minutes of a launch
...
| **Someone else triggers your launch** | 30% | 10% | 60% |

The "first buyer" is the person who actually executes the launch transaction on-chain. They receive a 10% share as a reward for putting your token live, while you still earn 30% as the creator.
...
|-----------|-------|---------|
| **Token Creator** | 40% (or 30%) | Rewards the token creator |
| **First Buyer** | 0% (or 10%) | Rewards the person who launched the token |
